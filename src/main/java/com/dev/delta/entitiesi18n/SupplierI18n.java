...
@Entity
@Table(name="supplieri18n")
public class SupplierI18n {
	@Id @GeneratedValue(strategy = GenerationType.IDENTITY)
	Long id;
	String  supplier_nameI18n;
	String   mobileI18n;
	String   addressI18n;
	String   detailsI18n;
	...
	public String getSupplier_nameI18n() {
		return supplier_nameI18n;
	}
	public void setSupplier_nameI18n(String supplier_nameI18n) {
		this.supplier_nameI18n = supplier_nameI18n;
	}
